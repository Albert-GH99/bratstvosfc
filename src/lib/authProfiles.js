...
export function roleCapabilities(role) {
  ...
  return {
    ...
    canViewPayments: fullAccess,
    canManagePayments: fullAccess,
    canViewPlans: fullAccess,
    canViewDomains: fullAccess || normalizedRole === 'support',
    canViewSupport: fullAccess || normalizedRole === 'support' || normalizedRole === 'staff',
