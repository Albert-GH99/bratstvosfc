...
export default function Unauthorized({ title = 'Access denied', message = 'This account does not have permission to open this area.', loginTo = '/login' }) {
  return (
    <div className="min-h-screen flex items-center justify-center px-6" style={{ background: 'var(--c-page-bg)', color: 'var(--c-text)' }}>
      <div className="premium-card max-w-lg w-full p-7 md:p-9">
        ...
        <p className="text-xs font-black uppercase tracking-widest mb-3" style={{ color: 'var(--c-accent)' }}>Unauthorized</p>
